...
async Task MessageHandler(ProcessMessageEventArgs processMessageEventArgs)
{
    ...
    Console.WriteLine($"Body: {body} - Subscription: {subscriptionName}");
...
serviceBusProcessor = serviceBusClient.CreateProcessor(topicName, subscriptionName,new ServiceBusProcessorOptions());
try
{
